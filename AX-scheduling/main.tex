...
\begin{figure*}[tb]
	...
	\node [text width=2cm, align=left] at (5, 1.25) {\quad RB 1};
	\node [text width=2cm, align=left] at (5, 1.75) {\quad RB 2};
	\node [text width=2cm, align=left] at (5, 2.25) {\quad...};
	\node [text width=2cm, align=left] at (5, 2.75) {\quad RB $F_1$};
	\node [text width=2cm, align=left] at (5, 3.25) {\quad RB $F_1+1$};
	\node [text width=2cm, align=left] at (5, 3.75) {\quad...};
	\node [text width=2cm, align=left] at (5, 4.25) {\quad RB $F_{max}$};
	\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
	(6,1) -- (6,3) node [black,midway,xshift=0.8cm] {$RA$};
	\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
	(6,3) -- (6,4.5) node [black,midway,xshift=0.8cm] {$DA$};
	...
	\node [text width=2cm, align=left] at (10.5, 1.25) {\quad RB 1};
	\node [text width=2cm, align=left] at (10.5, 1.75) {\quad RB 2};
	\node [text width=2cm, align=left] at (10.5, 2.25) {\quad...};
	\node [text width=2cm, align=left] at (10.5, 2.75) {\quad RB $F_Z$};
	\node [text width=2cm, align=left] at (10.5, 3.25) {\quad RB $F_Z+1$};
	\node [text width=2cm, align=left] at (10.5, 3.75) {\quad...};
	\node [text width=2cm, align=left] at (10.5, 4.25) {\quad RB $F_{max}$};
	\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
	(11.5,1) -- (11.5,3) node [black,midway,xshift=0.8cm] {$RA$};
	\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
	(11.5,3) -- (11.5,4.5) node [black,midway,xshift=0.8cm] {$DA$};
	\end{tikzpicture}
