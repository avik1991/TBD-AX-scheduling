...
\begin{figure*}[tb]
	...
	\node at (15,  0) {Time};
	\node at (1,  5) {Frequency};
	%\draw [line width=0.5mm] (1, 1) rectangle (2, 4.5);
	%\node [text width=1.5cm, align=center] at (1.5,  2.75) {\footnotesize{Бикон}};
	%\draw [line width=0.5mm] (13.25, 1) rectangle (14.25, 4.5);
	%\node [text width=1.5cm, align=center] at (13.75,  2.75) {\footnotesize{Бикон}};
	%\draw (1.0,  0) -- (1.0,  1);
	%\draw (12.0,  0) -- (12.0,  1);
	%\draw [arrows={triangle 45-triangle 45}] (1.0,0) -- (12.0,0);
	%\node at (6.5,  0.2) {$BI$};
	\draw [line width=0.5mm] (3, 1) rectangle (4, 4.5);
	\node [text width=1.5cm, align=center] at (3.5,  2.75) {TF 1};
	\draw [line width=0.5mm] (4, 1.0) rectangle (6, 1.5);
	\draw [line width=0.5mm] (4, 1.5) rectangle (6, 2.0);
	\draw [line width=0.5mm] (4, 2.0) rectangle (6, 2.5);
	\draw [line width=0.5mm] (4, 2.5) rectangle (6, 3.0);
	\draw [line width=0.5mm] (4, 3.0) rectangle (6, 3.5);
	\draw [line width=0.5mm] (4, 3.5) rectangle (6, 4.0);
	\draw [line width=0.5mm] (4, 4) rectangle (6, 4.5);
	\small
	\node [text width=2cm, align=center] at (5, 1.25) {RB 1};
	\node [text width=2cm, align=center] at (5, 1.75) {...};
	\node [text width=2cm, align=center] at (5, 2.25) {RB $F_1$};
	\node [text width=2cm, align=center] at (5, 2.75) {RB $F_1+1$};
	\node [text width=2cm, align=center] at (5, 3.25) {RB $F_1+2$};
	\node [text width=2cm, align=center] at (5, 3.75) {...};
	\node [text width=2cm, align=center] at (5, 4.25) {RB $F_{max}$};
	\normalsize
	\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
	(6,1) -- (6,2.5) node [black,midway,xshift=0.8cm] {$RA$};
	\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
	(6,2.5) -- (6,4.5) node [black,midway,xshift=0.8cm] {$DA$};
	\draw (3.0,  0.5) -- (3.0,  1.0);
	\draw (6.0,  0.5) -- (6.0,  1.0);
	\draw [arrows={triangle 45-triangle 45}] (3.0,0.5) -- (6.0,0.5);
	\node at (4.5,  0.8) {$L$};
	\node [text width=1.5cm, align=center] at (7.25, 2.75) {...};
	\draw [line width=0.5mm] (8.5, 1) rectangle (9.5, 4.5);
	\node [text width=1.5cm, align=center] at (9,  2.75) {TF $Z$};
	\draw [line width=0.5mm] (9.5, 1.0) rectangle (11.5, 1.5);
	\draw [line width=0.5mm] (9.5, 1.5) rectangle (11.5, 2.0);
	\draw [line width=0.5mm] (9.5, 2.0) rectangle (11.5, 2.5);
	\draw [line width=0.5mm] (9.5, 2.5) rectangle (11.5, 3.0);
	\draw [line width=0.5mm] (9.5, 3.0) rectangle (11.5, 3.5);
	\draw [line width=0.5mm] (9.5, 3.5) rectangle (11.5, 4.0);
	\draw [line width=0.5mm] (9.5, 4) rectangle (11.5, 4.5);
	\small 
	\node [text width=2cm, align=center] at (10.5, 1.25) {RB $1$};
	\node [text width=2cm, align=center] at (10.5, 1.75) {$...$};
	\node [text width=2cm, align=center] at (10.5, 2.25) {RB $F_Z$};
	\node [text width=2cm, align=center] at (10.5, 2.75) {RB $F_Z+1$};
	\node [text width=2cm, align=center] at (10.5, 3.25) {RB $F_Z+2$};
	\node [text width=2cm, align=center] at (10.5, 3.75) {$...$};
	\node [text width=2cm, align=center] at (10.5, 4.25) {RB $F_{max}$};
	\normalsize
	\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
	(11.5,1) -- (11.5,2.5) node [black,midway,xshift=0.8cm] {$RA$};
	\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt},yshift=0pt]
	(11.5,2.5) -- (11.5,4.5) node [black,midway,xshift=0.8cm] {$DA$};
	\end{tikzpicture}
	\caption{\label{fig:APprocess} Data transmission process from the AP's point}
\end{figure*}

%ИЗМЕНИBecause of paper space limitation, here we briefly describe 802.11ax peculiarities related to OFDMA, while for the detail description, an interested reader may refer to [2]–[4].
...
One of the most important technological enhancements of
...
%trigger = preamble + (28 + 5 * ui + 3) / 34 / 1e6;
...
\noindent\begin{figure*}[htb]
	\centering
	\begin{tikzpicture}
	\draw [arrows={-triangle 45}] (-0.5,1) -- (14,1);
	
	\draw [arrows={-triangle 45}] (0.4,2.3) -- (0.4,1);
	...
	\node at (0.45,  2.2) {\scriptsize\ \ data arrival};
	\node at (0,  1.8) {$none$};
	\node at (0.7,  1.8) {$b_0$};
	\node at (1.5,  1.8) {$b_1$};
	\node at (2.5,  1.4) {$...$};
	...
	\draw[draw = none,pattern=north east lines, pattern color=black, ] (4,1) rectangle (5,2);
	
	\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt}]
	(0,1) -- (5,1) node [black,midway,xshift=0cm,yshift=-0.34cm, below] {\textit{channel access phase}};
	...
	\draw [decorate,decoration={brace,amplitude=10pt,mirror,raise=4pt}]
	(5,1) -- (11,1) node [black,midway,xshift=0cm,yshift=-0.34cm, below] {\textit{transmission phase}};
	
	%\node at (14,  1.8) {$b(t)$};
	\node at (14,  1.2) {$t$};
	\end{tikzpicture}
	\caption{\label{fig:STAprocess} Data transmission process from the STA point}
\end{figure*}

\section{Considered process}
...
If request for the  packet transmission was successful the AP includes this STA in a list of stations in DA and in the next trigger frames scheduler will take this station into account when allocating RBs. 
...
\section{Main features of OFDMA in 802.11ax}
...
\begin{figure}[tb]
	\centering
	\begin{tikzpicture}
	\draw [arrows={-triangle 45}] (0,1) -- (8,1);
	\draw [arrows={-triangle 45}] (0,1) -- (0,4);
	\node at (8,  0.5) {Time};
	\node at (1,  4) {Frequency};
	\draw [line width=0.5mm] (1, 1) rectangle (2, 3);
	...
	\node [text width=2cm, align=left] at (4, 2.25) {\quad...};
	\node [text width=2cm, align=left] at (4, 2.75) {\quad STA $x$};
	\draw [line width=0.5mm] (6, 1) rectangle (7.2, 3);
	\node [text width=1.5cm, align=center] at (6.6,  2) {Multi-STA BA};
