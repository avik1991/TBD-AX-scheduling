...
\todo{Abstract - almost done -- need revision}
\begin{abstract}
...
In the next Section~\ref{sec:adaptations}, we illustrate, how known schedulers can be adapt for 11ax networks.
	...
	{\centering
		...
		\resizebox{\columnwidth}{!}{
			...
			\begin{tabular}{|c|c|c|c|c|c|c|}
				...
				\hline
				BPSK, 1/2	&0.8	&1.7	&3.5	&8.1 & 16.3 &34		\\
				QPSK, 1/2	&1.7	&3.3	&7.1	&16.3 & 32.5 &68.1		\\
				QPSK, 3/4	&2.5	&5	&10.6	&24.4 & 48.8 &102.1		\\
				16-QAM, 1/2	&3.3	&6.7	&14.2	&32.5 & 65 &136.1		\\
				16-QAM, 3/4	&5	&10	&21.3	&48.8 & 97.5 &204.2		\\
				64-QAM, 2/3	&6.7	&13.3	&28.3	&65 & 130 &272.2		\\
				64-QAM, 3/4	&7.5	&15	&31.9	&73.1 & 146.3 &306.3		\\
				64-QAM, 5/6	&8.3	&16.7	&35.4	&81.3 & 162.5 &340.3		\\
				256-QAM, 3/4	&10	&20	&42.5	&97.5 & 195 &408.3		\\
				256-QAM, 5/6	&11.1	&22.2	&47.2	&108.3 & 216.7 &453.7		\\
				1024-QAM, 3/4	& --	&--	&--	&121.9 & 243.8 &510.4		\\
				1024-QAM, 5/6 	& --	&--	&--	&135.4 & 270.8 &576.1		\\
				\hline
			\end{tabular}
		}
	}
...
Problem statement: \textit{to adapt known schedulers which work in traditional Wi-Fi and 4G networks to 11ax networks.}
...
For example, if scheduler choses to allocate 242, 106, 26, 52, 26, 26-tones RUs to stations respectively then $M = 6$. 
Note that utility function intuitively should be $U = U(allocation, mcs)$ here because as it was shown in section~\ref{sec:features} that several performance indicators can vary greatly depending on the allocation and MCS.

So, we represent the function $U$ in the following form
$$
U = \sum_{i} \sum_{j} x_i^j \lambda_i^j
$$

\begin{align} 
\max \sum_{i} \sum_{j} x_i^j \lambda_i^j; \\ \label{usl312}
\text{subject to} \sum_{i} x_i^j \leq 1,\ \  \forall j; \\ \label{usl313}
\sum_{j} x_i^j \leq 1, \ \ \forall i; \\ \label{usl314}
\sum_{i} \sum_{j} x_i^j \leq m,
\end{align}

Dynamic programming algorithm to solve the problem:~\cite{bourgeois1971extension}. This algorithm is also known as Hungarian algorithm.  

\begin{table}[t]
\centering
\caption{\label{table:matrixexm} Example on Hungarian algorithm}
\resizebox{0.7\columnwidth}{!}{
\setlength\tabcolsep{4pt} % default value: 6pt
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|c|}
\hline
& \multicolumn{10}{|c|}{Users' Stations}  \\\hline
\parbox[t]{2mm}{\multirow{7}{*}{\rotatebox[origin=c]{90}{Resource Units}}} & 2 & 2 & 3 & 6 & 7 & 1 & 3 & \cellcolor{prpl!100}6 & 2 & 6 \\\cline{2-11}
